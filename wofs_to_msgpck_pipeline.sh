...
BLOB_NCAR="https://wofsdltornado.blob.core.windows.net"
...
#--wofs_save_path=${BLOB_NCAR}/wrf-wofs  \
...
--account_url_ncar=$ACCOUNT_URL_NCAR  \
--queue_name_ncar=$QUEUE_NAME_NCAR  \
--wofs_save_path='/datadrive2/wofs'  \
--datetime_format="%Y-%m-%d_%H:%M:%S"  \
--dir_preds="$BLOB_NCAR/wofs-preds/"  \
--dir_patches="$BLOB_NCAR/wofs-patches/" \
--with_nans  \
