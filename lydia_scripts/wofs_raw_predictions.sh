...
#YYYY-MM-DD_hh:mm:ss
#python lydia_scripts/wofs_raw_predictions.py \
#--loc_wofs="/ourdisk/hpc/ai2es/wofs/2019/20190517/0300/ENS_MEM_12/wrfwof_d01_2019-05-18_03:15:00"  \
#--datetime_format="%Y-%m-%d_%H:%M:%S"  \
#--dir_preds="/ourdisk/hpc/ai2es/momoshog/Tornado/tornado_jtti/wofs_preds/2019/20190517/0300/ENS_MEM_12"  \
#--dir_patches="/ourdisk/hpc/ai2es/momoshog/Tornado/tornado_jtti/wofs_patches/2019/20190517/0300/ENS_MEM_12" \
#--dir_figs="/ourdisk/hpc/ai2es/momoshog/Tornado/tornado_jtti/wofs_figs/2019/20190517/0300/ENS_MEM_12/wrfwof_d01_2019-05-18_03:15:00" \
#--with_nans  \
#--loc_model="/ourdisk/hpc/ai2es/tornado/unet/ZH_only/initialrun_model8/initialrun_model8.h5"  \
#--file_trainset_stats="/ourdisk/hpc/ai2es/tornado/learning_patches/tensorflow/3D_light/training_onehot_tor/training_metadata_ZH_only.nc" \
#--write=0  \
