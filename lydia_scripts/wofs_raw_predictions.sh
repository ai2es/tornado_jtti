...
#SBATCH --chdir=/ourdisk/hpc/ai2es/alexnozka/tornado_jtti/
#SBATCH --output=/ourdisk/hpc/ai2es/alexnozka/debug/%x_%j.out
#SBATCH --error=/ourdisk/hpc/ai2es/alexnozka/debug/%x_%j.err
#SBATCH --array=20%1 #--array=0-37%20 #

##########################################################

# Source conda env
#source home/momoshog/.bashrc
#bash
...
--dir_preds="/ourdisk/hpc/ai2es/alexnozka/results/wofs/wofs_preds/2023/${WOFS_REL_PATH}"  \
--dir_patches="/ourdisk/hpc/ai2es/alexnozka/results/wofs/wofs_patches/2023/${WOFS_REL_PATH}" \
--dir_figs="/ourdisk/hpc/ai2esalexnozka/results/wofs/wofs_figs/2023/${WOFS_REL_PATH}/${WOFS_FILE}" \
