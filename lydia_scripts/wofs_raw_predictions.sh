...
WOFS_REL_PATH="20190430/1900/ENS_MEM_1"
...
echo "exit code: $EC"
if [ $EC -eq 0 ]; then
    echo "rm ${SLURM_JOB_NAME}_${SLURM_JOBID}_out.txt"
    #rm ${SLURM_JOB_NAME}_${SLURM_JOBID}_out.txt
    #rm /home/momoshog/Tornado/slurm_out/tornado_jtti/$SLURM_JOB_NAME_$SLURM_ARRAY_JOB_ID_err.txt
fi
